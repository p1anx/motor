...
{
    SEGGER_RTT_ConfigUpBuffer(1, "JScope_T4F4F4", &JS_RTT_Buffer[0], sizeof(JS_RTT_Buffer), SEGGER_RTT_MODE_BLOCK_IF_FIFO_FULL);
}
...
void test_motor_pid_currentVelocityLoopBandwidth(void)
{
    ...
    pid_iq.D = 0.0f;
    PIDController pid_velocity;
    pid_velocity.P = 0.12f;
    pid_velocity.I = 0.05f;//0.05
    pid_velocity.D = 0.0f;
