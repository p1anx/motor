...
#define ESP8266_IO_Pin GPIO_PIN_13

#define ESP8266_RUN_MODE() HAL_GPIO_WritePin(ESP8266_IO_GPIO_Port,ESP8266_IO_Pin, SET)
#define ESP8266_FIRE_MODE() HAL_GPIO_WritePin(ESP8266_IO_GPIO_Port,ESP8266_IO_Pin, RESET)
