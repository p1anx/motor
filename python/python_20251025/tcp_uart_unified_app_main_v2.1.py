...
class CommunicationPage(QWidget):
    ...
    def go_back(self):
        """返回主界面"""
        self.parent_app.show_main_page()
...
class TCPUARTUnifiedApp(QMainWindow):
    ...
    def init_main_page(self):
        ...
        # 通信功能按钮
        self.communication_page_button = QPushButton("TCP/UART通信")
        self.communication_page_button.setStyleSheet("""
            QPushButton {
                background-color: #3498db;
                color: white;
                border: none;
        ...
        """)
        self.communication_page_button.clicked.connect(self.show_communication_page)
        
        # 同步控制按钮
        self.sync_page_button = QPushButton("同步控制")
        self.sync_page_button.setStyleSheet("""
            QPushButton {
        ...
        """)
        self.sync_page_button.clicked.connect(self.show_sync_page)
        
        function_layout.addWidget(self.communication_page_button)
        function_layout.addWidget(self.sync_page_button)
    ...
    def init_communication_page(self):
        ...
        self.stacked_widget.addWidget(self.communication_page)
    ...
    def init_navigation_bar(self, parent_layout):
        ...
        # 通信功能按钮
        self.communication_nav_button = QPushButton("TCP/UART通信")
        self.communication_nav_button.setStyleSheet("""
            QPushButton {
                background-color: #3498db;
                color: white;
                border: none;
        ...
        """)
        self.communication_nav_button.clicked.connect(self.show_communication_page)
        nav_layout.addWidget(self.communication_nav_button)
        
        # 同步控制按钮
        self.sync_control_button = QPushButton("同步控制")
        self.sync_control_button.setStyleSheet("""
            QPushButton {
                background-color: #f39c12;
                color: white;
                border: none;
        ...
        """)
        self.sync_control_button.clicked.connect(self.show_sync_page)
        nav_layout.addWidget(self.sync_control_button)
