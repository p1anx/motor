...
def plot_qam_constellation(file, fs=284, start=231, step=270, g_n_point=10, column=2, saved_foler = "data_img"):
    data = m.read_csv(file, column)
    # fs = 280
    # start = 430
    # step = 570
...
def test_plot_qam_constellation():
    ...
    plot_qam_constellation(
        csv_file, fs=255, start=start, step=step, g_n_point=g_n_point, saved_foler=img_folder
    )
