...
// #define CONFIG_CONTROLLER_TYPE ControllerType_velocityAngleClosedLoop
...
typedef struct {
  ...
  PIDController_t PID_Velocity, PID_VelocityAngle, PID_Angle, PID_Current,PID_Id, PID_Iq, PID_iVelocity, PID_iVelDegree; // PID_iVelocity for  velocity pid using currentloop
}PID_t ;
