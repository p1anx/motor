...
typedef enum
{
    ...
    ControlType_currentVelocityOpenLoop,
    ControlType_currentVelocityOpenLoopInline,
    ControlType_angle_openloop,
    ControlType_velocityClosedLoop, //!< Velocity motion control
    ControlType_velocityAngleClosedLoop, //!< Velocity motion control
    ControlType_velocityClosedLoopInline, //!< Velocity motion control
    ...
    ControlType_currentVelocityClosedLoopBandwidth,  //!< angle motion control
    ControlType_currentAngleClosedLoopBandwidth,  //!< angle motion control
    ControlType_currentVelocityRPMClosedLoopBandwidth,  //!< angle motion control
    ControlType_currentVelocityAngleClosedLoopBandwidth,  //!< angle motion control
    ControlType_currentClosedLoopBandwidth_debug,  //!< angle motion control
} ControlType_t;
...
struct FOCMotor_t
{
    ...
    PIDController PID_i_d;       //!< parameter determining the velocity PI configuration
    PIDController PID_i_q;       //!< parameter determining the velocity PI configuration
...
float FOCMotor_shaftAngleDegrees(FOCMotor_t *motor);
#endif // !__FOC_MOTOR_H
