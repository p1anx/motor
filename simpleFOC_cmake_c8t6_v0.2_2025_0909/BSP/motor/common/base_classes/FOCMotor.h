/*
 * FOCMotor.h
 * Ported from: https://github.com/simplefoc/Arduino-FOC/blob/master/src/common/base_classes/FOCMotor.h
 ...
 * @param motor - Pointer to FOCMotor structure
 * @param sensor - Sensor wrapper for the FOC algorithm to read motor angle and velocity
 */
