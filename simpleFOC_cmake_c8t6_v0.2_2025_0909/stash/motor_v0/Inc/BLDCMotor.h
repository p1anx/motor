 ...
 * @param motor - Pointer to BLDCMotor structure
 * @param driver - BLDCDriver implementing all hardware specific functions necessary for PWM setting
 */
 ...
 * @param motor - Pointer to BLDCMotor structure
 * @param zero_electric_offset - value of the sensors absolute position electrical offset
 ...
 *                 If it is NOT_SET the motor will use the target set in its variable motor.target
