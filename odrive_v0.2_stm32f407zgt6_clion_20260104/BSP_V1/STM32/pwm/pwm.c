...
int PWM_Init(PWM_t* pwm) {
    ...
    __HAL_TIM_SET_COMPARE(pwm->htim, TIM_CHANNEL_1, default_resolution-1 - 0);
    __HAL_TIM_SET_COMPARE(pwm->htim, TIM_CHANNEL_2, default_resolution-1 - 0);
    __HAL_TIM_SET_COMPARE(pwm->htim, TIM_CHANNEL_3, default_resolution-1 - 0);
