...
int qam_time_improved[32] = {0, 125,0, 51,0, 198,0, 125,0, 301,0, 375,0, 448,0, 375,0, 551-500,0, 625-500,0, 698-500,0, 625-500,0, 801-500,0, 875-500,0, 948-500,0, 875-500};
...
void TIM_QAM16_standard(TIM_HandleTypeDef *htim) {
  /* 判断中断是由哪个定时器产生的 */
  if (htim->Instance == TIM3)
  {
    memcpy(qam_time, qam_time_standard, sizeof(qam_time_standard));
    //memcpy(qam_time, qam_time_improved, sizeof(qam_time_improved));
