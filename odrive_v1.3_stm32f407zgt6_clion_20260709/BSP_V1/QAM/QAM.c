...
void QAM_run16QAM_standard(Motor_t *motor) {
  ...
  //{948, 875};
  //
  //int qam_time_standard[32] = {125, 51, 198, 125, 301, 375, 448, 375, 551, 625, 698, 625, 801, 875, 948, 875};
  //int qam_time_standard[32] = {0, 125,0, 51,0, 198,0, 125,0, 301,0, 375,0, 448,0, 375,0, 551,0, 625,0, 698,0, 625,0, 801,0, 875,0, 948,0, 875};
...
void QAM_run16QAM_standard_improved(Motor_t *motor) {
  // printf("in function\n");
  float bias = 3.6f;
  //float QAM_AMP[4] = {20.6f+bias, 43.1f+bias, 64.7f+bias, 104.8f+bias};
  float QAM_AMP[16] = {39.27f, 68.59f, 68.59f, 110.f, 68.59f, 39.27f,68.59f, 110.f, 68.59f + 180.f, 39.27f + 180.f,68.59f + 180.f, 110.f + 180.f, 68.59f+180.f, 39.27f+180.f,68.59f+180.f, 110.f+180.f};
...
void QAM16_standard_Test_improved(void) {
  printf("===================================\r\n");
  printf("             QAM Debug             \r\n");
  printf("===================================\r\n");
  Motor_InitConfig(&motor);
  ...
  while (1) {
    ...
    QAM_run16QAM_standard_improved(&motor);
    Motor_move(&motor, motor.ref);
