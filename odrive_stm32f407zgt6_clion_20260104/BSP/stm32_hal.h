...
#define print_uart CONFIG_UART_PRINTF
...
// DEBUG_WARN("Sensor calibration needed");
// DEBUG_INFO("Motor initialized");
// DEBUG_OK("AS5600 connected successfully");
