...
#define CONFIG_CUR_VEL_FREQ  (CONFIG_CUR_FREQ/10)      //velocity loop frequency(Hz)
#define CONFIG_CUR_VEL_POS_FREQ  (CONFIG_CUR_FREQ/10)      //position loop frequency(Hz)
...
// #define CONFIG_DRIVER_DEADTIME    100

#if 0
#define CONFIG_DRIVER_R_SAMPLE CONFIG_ODRIVE_R_SAMPLE //ohm 0.001
#define CONFIG_DRIVER_GAIN     CONFIG_ODRIVE_GAIN    // 50
#else
#define CONFIG_DRIVER_R_SAMPLE 0.001 //ohm 0.001
#define CONFIG_DRIVER_GAIN     50    // 50
...
//================================================
//0.005
#define CONFIG_VELOCITY_FILTER_Tf 0.001    //!< default velocity filter time constant
...
#define CONFIG_IA_LPF_CUTOFF  100 //!< default velocity filter time constant
#define CONFIG_IB_LPF_CUTOFF  100 //!< default velocity filter time constant
...
#define CONFIG_FILTER_Tf 0.001    //!< default velocity filter time constant
...
// typedef struct gVars_t gVars_t;
