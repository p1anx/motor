...
#define  BLDCDRIVER_ENABLE_PORT CONFIG_DRIVER_ENABLE_PORT
#define  BLDCDRIVER_ENABLE_PIN  CONFIG_DRIVER_ENABLE_PIN
#define  BLDCDRIVER_PWM_HTIM    CONFIG_DRIVER_PWM_HTIM
#define  BLDCDRIVER_DEADTIME    CONFIG_DRIVER_DEADTIME
